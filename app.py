...
def main():
    ...
    with tabs[2]:
        ...
        st.markdown("""
        This tool identifies groups of accounts sharing near-identical content. 
        we are looking for a very specific type of suspicious behavior where multiple 
        accounts post the exact same message word-for-word.
        """)
